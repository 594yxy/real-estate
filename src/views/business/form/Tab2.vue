        ...
        >
                ...
                <a-row :gutter="gutter">
                      ...
                      <a-input read-only placeholder="请输入姓名" v-model="pane.salerName">
                        <a-tooltip slot="addonAfter" title="点击读取信息">
                          <a-icon
                            ...
                            @click.native="getIdCardInfo(index, 'saler')"
                          />
                        </a-tooltip>
                      </a-input>
                    </a-form-model-item>
                  ...
                  <a-col :xs="24" :sm="24" :md="12" :xl="8">
                    <a-form-model-item
                      ...
                      :wrapperCol="wrapperCol"
                      label="身份证有效期"
                      :prop="'salerList['+index+'].salerIdcardValidity'"
                      :rules="rules.must"
                    >
                      <a-range-picker format="YYYY-MM-DD" v-model="pane.salerIdcardValidity" />
                    </a-form-model-item>
                  </a-col>
                  <a-col :xs="24" :sm="24" :md="12" :xl="8">
                    <a-form-model-item
                ...
                <a-row :gutter="gutter">
                  ...
                  <a-col :xs="24" :sm="24" :md="12" :xl="8">
                    <a-form-model-item
                      ...
                      :wrapperCol="wrapperCol"
                      label="身份证有效期"
                      :prop="'salerList['+index+'].assignor.personIdcardValidity'"
                      :rules="rules.must"
                    >
                      <a-range-picker
                        format="YYYY-MM-DD"
                        v-model="pane.assignor.personIdcardValidity"
                      />
                    </a-form-model-item>
                  </a-col>
                  <a-col :xs="24" :sm="24" :md="12" :xl="8">
          ...
          <div class="card-wrap" v-if="pane.guardianList.length > 0">
            ...
            <a-card :bodyStyle="{padding: 0}">
              <div
                class="card-item"
                v-for="(guardian, keyIndex) in pane.guardianList"
                :key="keyIndex"
              >
                <a-row :gutter="gutter">
                  <a-col :xs="24" :sm="24" :md="12" :xl="8">
                  ...
                  <a-col :xs="24" :sm="24" :md="12" :xl="8">
                    <a-form-model-item
                      ...
                      :wrapperCol="wrapperCol"
                      label="身份证有效期"
                      :prop="'salerList['+index+'].guardianList['+keyIndex+'].personIdcardValidity'"
                      :rules="rules.must"
                    >
                      <a-range-picker format="YYYY-MM-DD" v-model="guardian.personIdcardValidity" />
                    </a-form-model-item>
                  </a-col>
                  <a-col :xs="24" :sm="24" :md="12" :xl="8">
                    <a-form-model-item
                    ...
                    >
                      ...
                      >
                        <UploadImg
                          tip="身份证人像面"
                          :isCard1="true"
                          @setImageValue="file => setImageData(file, index, 'personIdcardFront', 'guardianList',keyIndex)"
                      ...
                      >
                        <UploadImg
                          tip="身份证国徽面"
                          :isCard2="true"
                          @setImageValue="file => setImageData(file, index, 'personIdcardBack', 'guardianList',keyIndex)"
          ...
          <div class="card-wrap">
            <div class="card-header">
              ...
              <a-button
                type="primary"
                @click.native="addBank(index,'SALER_DOWN_PAYMENT')"
                class="mr-8"
              >添加首期收款银行</a-button>
                  ...
                  <a-col :xs="24" :sm="24" :md="24" :xl="16">
                    ...
                    >
                      ...
                      >
                        <UploadImg
                          tip="银行卡正面"
                          @setImageValue="file => setImageData(file, index, 'bankCardFront', 'bankAccountList',bankIndex)"
                      ...
                      >
                        <UploadImg
                          tip="银行卡背面"
                          @setImageValue="file => setImageData(file, index, 'bankCardBack', 'bankAccountList',bankIndex)"
